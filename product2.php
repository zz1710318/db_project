...
<html lang="en">
  <head>
    ...
    // Query to fetch products with pagination
      $stmt = $link->prepare("SELECT * FROM `product` WHERE type = 'Long Sleeve Top' LIMIT :limit OFFSET :offset");
    ...
    // Count total number of products
      $stmt_count = $link->prepare("SELECT COUNT(*) as total FROM `product` WHERE  type = 'Long Sleeve Top'");
      $stmt_count->execute();
...
<?php
    if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['addToCart'])) {
        ...
        echo '<script>window.location.href="product2.php";</script>';
    }
?>
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Long Sleeve Top</li>
        </ol>
      </div>
     </div>
   </div>
