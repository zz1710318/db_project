...
<html lang="en">
  <head>
    ...
    // Query to fetch products with pagination
      $stmt = $link->prepare("SELECT * FROM `product` WHERE name LIKE '%T-shirts%' AND type = 'Short Sleeves' LIMIT :limit OFFSET :offset");
    ...
    // Count total number of products
      $stmt_count = $link->prepare("SELECT COUNT(*) as total FROM `product` WHERE name LIKE '%T-shirts%' AND type = 'Short Sleeves'");
      $stmt_count->execute();
...
<?php
    if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['addToCart'])) {
        ...
        echo '<script>window.location.href="product1-2.php";</script>';
    }
?>
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="product1.php">Short Sleeves</a></li>          
